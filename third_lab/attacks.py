...
from third_lab.connection import Connection, print_package
from third_lab.client import Client
from third_lab.hacker import Hacker
...
def run_attacks():
    ...
    connection = Connection([client, server1, server2], [])
